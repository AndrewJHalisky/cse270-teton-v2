...
class TestDefaultSuite():
  ...
  def test_homeTest(self):
    ...
    self.driver.set_window_size(827, 1176)
  ...
  def test_directoryTest(self):
    ...
    self.driver.set_window_size(1034, 1176)
  ...
  def test_adminTest(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("augustwreck")
    self.driver.find_element(By.ID, "password").click()
  ...
  def test_joinTest(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "textarea").send_keys("Big Man\'s is a nonprofit organization.")
    self.driver.find_element(By.NAME, "submit").click()
